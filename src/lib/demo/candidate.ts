...
const evidence: Evidence[] = [
  ...
  {
    id: "ev_api",
    claim: "Built a FastAPI backend serving model inference over a REST API for a hackathon project",
    category: "project",
    sourceType: "github",
    sourceReference: "github.com/avechen/quickserve",
    strength: "moderate",
    recency: "recent",
    publicProof: true,
    trust: "source-backed",
  ...
  {
    id: "ev_coursemap",
    claim: "Shipped CourseMap, a course-planning web app used by about 200 classmates each registration period",
    category: "project",
    sourceType: "github",
    sourceReference: "github.com/avechen/coursemap",
    strength: "strong",
    recency: "current",
    publicProof: true,
    trust: "source-backed",
  ...
  {
    id: "ev_oss",
    claim: "Merged a bug-fix pull request into an open-source Python data-validation library",
    category: "experience",
    sourceType: "github",
    sourceReference: "github.com/avechen (public contribution history)",
    strength: "moderate",
    recency: "recent",
    publicProof: true,
    trust: "source-backed",
